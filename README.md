...
| **kubernetes/argo-workflows/** | Argo Workflows の UI で閲覧するための Helm 値例（client 認証）、閲覧用 RBAC、手順は [kubernetes/argo-workflows/README.md](kubernetes/argo-workflows/README.md)。 |
